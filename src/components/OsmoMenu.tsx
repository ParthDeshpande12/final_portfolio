  ...
  const handleMenuToggle = async () => {
    if (typeof window !== "undefined") {
      ...
      if (!open) {
        // Open animation
        setOpen(true)
        if (navWrap && menu && menuCloseButton && menuButtonTexts && menuButtonIcon && overlay && bgPanels && menuLinks && fadeTargets) {
          tl.clear()
        ...
        // Close animation
        if (navWrap && menu && menuCloseButton && menuButtonTexts && menuButtonIcon && overlay) {
          tl.clear()
