    ...
    <AnimatePresence>
      {loaderShown && (
        <motion.div
          ...
          className="fixed top-0 left-0 w-full z-[100] flex items-center justify-between px-4 sm:px-6 md:px-8 py-3 sm:py-4"
        >
          {/* BIO Button top left */}
          <div className="pointer-events-auto">
            <Link href="/" className="group" prefetch={false}>
              <span className="relative text-sm sm:text-base font-semibold text-white cursor-pointer select-none">
                HOME
          ...
          <div className="relative pointer-events-auto" ref={menuRef}>
            ...
            >
              <span className="flex items-center gap-2 relative">
                <span className="menu-button-text p-large text-sm sm:text-base">SUMAN RANA</span>
                ...
                <div className="menu-inner">
                  ...
                  <div className="menu-details">
                    ...
                    <div className="socials-row">
                      <Link href="#" data-menu-fade className="social-link" onClick={handleMenuToggle}>
                        Instagram
                      </Link>
                      <Link href="#" data-menu-fade className="social-link" onClick={handleMenuToggle}>
                        LinkedIn
      ...
      body {
        ...
        * {
        ...
        @font-face {
          ...
          src: url('https://fonts.googleapis.com/css2?family=Philosopher:wght@400;700&display=swap') format('woff2');
          font-weight: 400;
          font-style: normal;
          font-display: swap;
        }
        ...
        /* CSS Variables */
        :root {
          --color-primary: #8B5C2A; // hazelnut brown
          --color-neutral-100: #f8f8f8;
          --color-neutral-200: #e8e8e8;
          --color-neutral-300: #F5E9DA;
          --color-neutral-800: #2a2a2a;
          --color-dark: #131313;
          --color-brown-namaste: #4B2E19;
          --menu-padding: 2em;
        ...
        .menu-close-button {
          color: var(--color-brown-namaste) !important;
          ...
          border: none;
          box-shadow: none;
          font-size: 0.85em !important; /* 15% reduction from 1em */
        }
        ...
        .menu-link-heading {
          ...
          font-size: 4.78em !important; /* 15% reduction from 5.625em */
          font-weight: 700;
          line-height: 0.75;
